...
import { createLogger, BadRequestError, NotFoundError, UnauthorizedError } from '@shared/index.ts';
...
export async function acceptFriendRequest(friendshipId: string, userId: string) {
  ...
  if (friendship.friendId !== userId) {
    throw new UnauthorizedError('Not authorized to accept this request');
  }
...
export async function rejectFriendRequest(friendshipId: string, userId: string) {
  ...
  if (friendship.friendId !== userId) {
    throw new UnauthorizedError('Not authorized to reject this request');
  }
